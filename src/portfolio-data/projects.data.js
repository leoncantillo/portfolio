...
export const projects = [
  ...
  },
  {
    ...
    complete_description:
      "ReservasUno es un peoyecto acadmémico donde creamos un sistema de reservas aéreas que permite a los usuarios buscar vuelos, seleccionar trayectos, gestionar reservas y consultar información asociada. El proyecto integra un frontend web con una API REST desarrollada en Spring Boot, incluyendo autenticación basada en JWT, transferencia de datos con DTOs y persistencia de datos en PostgreSQL. Fue desarrollado como proyecto de aprendizaje enfocado en arquitectura backend y buenas prácticas iniciales.",
    ...
    learnings: [
      ...
      "Diseño de APIs REST",
      "Manejo de dependendicas con Maven",
