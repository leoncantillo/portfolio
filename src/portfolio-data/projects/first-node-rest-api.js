...
export default {
  ...
  gallery: [
    { src: media.gallery[0].src, alt: "", type: media.gallery[0].type },
    { src: media.gallery[1].src, alt: "", type: media.gallery[1].type },
    { src: media.gallery[2].src, alt: "", type: media.gallery[2].type },
    { src: media.gallery[3].src, alt: "", type: media.gallery[3].type },
    { src: media.gallery[4].src, alt: "", type: media.gallery[4].type },
    { src: media.gallery[5].src, alt: "", type: media.gallery[5].type },
    { src: media.gallery[6].src, alt: "", type: media.gallery[6].type },
    { src: media.gallery[7].src, alt: "", type: media.gallery[7].type },
    { src: media.gallery[8].src, alt: "", type: media.gallery[8].type },
    { src: media.gallery[9].src, alt: "", type: media.gallery[9].type },
    { src: media.gallery[10].src, alt: "", type: media.gallery[10].type },
    { src: media.gallery[11].src, alt: "", type: media.gallery[11].type },
    { src: media.gallery[12].src, alt: "", type: media.gallery[12].type },
    { src: media.gallery[13].src, alt: "", type: media.gallery[13].type },
  ],
